...
# What follows is more or less the Python official docker image commands
# Re-ordered to allow some pip dependencies access to .build-deps
...
# https://github.com/alpinelinux/aports/commit/2026e1259422d4e0cf92391ca2d3844356c649d0
    ...
    && apk add --no-cache --virtual .application-deps tini sqlite
